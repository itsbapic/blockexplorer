...
const MyComponent = () => {
    ...
    useEffect(() => {
        ...
        script1.src = "https://cdnjs.cloudflare.com/ajax/libs/p5.js/0.7.2/p5.js";
        script1.async = true;
        document.body.appendChild(script1);

        const script2 = document.createElement("script");
        script2.src = "https://cdnjs.cloudflare.com/ajax/libs/p5.js/0.7.2/addons/p5.dom.js";
        script2.async = true;
        document.body.appendChild(script2);

        const script3 = document.createElement("script");
        script3.src = "sketch_cascade.js";
        script3.async = true;
        document.body.appendChild(script3);

        const script4 = document.createElement("script");
        script4.src = "keyboardEngine_190221.js";
        script4.async = true;
        ...
        link2.href = "https://fonts.googleapis.com/css?family=IBM+Plex+Mono:100,300,300i,400";
    ...
    return (
        <div className="bottom">
            <textarea id="textfield" hidden={true} defaultValue={"0xf88d93e6f450e619bf3dcbd985d837695c3d8b8cd8693b518b622e711e3b6834"}>
            </textarea>
        </div>
    );
};
